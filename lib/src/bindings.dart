...
DynamicLibrary _openLib() {
    ...
    try {
        ...
        throw UnsupportedError('Could not open native library for ABI: $abi on ${Platform.operatingSystem}.\nTried: ${candidates.join(', ')}.\nSet environment variable $envVar to force a path.\nOriginal error: $e');
    }
}
...
final spListPorts = _lib
    .lookupFunction<_SpListPortsC, _SpListPortsDart>('sp_list_ports');
...
final spGetPortName = _lib
    .lookupFunction<_SpGetPortNameC, _SpGetPortNameDart>('sp_get_port_name');
...
final spGetPortDescription = _lib
    .lookupFunction<_SpGetPortDescriptionC, _SpGetPortDescriptionDart>('sp_get_port_description');
...
final spGetPortTransport = _lib
    .lookupFunction<_SpGetPortTransportC, _SpGetPortTransportDart>('sp_get_port_transport');

typedef _SpGetPortUsbVidPidC = Int32 Function(
    Pointer<Void>, Pointer<Uint16>, Pointer<Uint16>);
typedef _SpGetPortUsbVidPidDart = int Function(
    Pointer<Void>, Pointer<Uint16>, Pointer<Uint16>);
final spGetPortUsbVidPid = _lib
    .lookupFunction<_SpGetPortUsbVidPidC, _SpGetPortUsbVidPidDart>('sp_get_port_usb_vid_pid');

typedef _SpGetPortUsbBusAddressC = Int32 Function(
    Pointer<Void>, Pointer<Uint8>, Pointer<Uint8>);
typedef _SpGetPortUsbBusAddressDart = int Function(
    Pointer<Void>, Pointer<Uint8>, Pointer<Uint8>);
final spGetPortUsbBusAddress = _lib
    .lookupFunction<_SpGetPortUsbBusAddressC, _SpGetPortUsbBusAddressDart>('sp_get_port_usb_bus_address');

typedef _SpGetPortByNameC = Int32 Function(
    Pointer<Utf8>, Pointer<Pointer<Void>>);
typedef _SpGetPortByNameDart = int Function(
    Pointer<Utf8>, Pointer<Pointer<Void>>);
final spGetPortByName = _lib
    .lookupFunction<_SpGetPortByNameC, _SpGetPortByNameDart>('sp_get_port_by_name');

// ---------- Port Management ----------
typedef _SpOpenC = Int32 Function(Pointer<Void>, Int32);
typedef _SpOpenDart = int Function(Pointer<Void>, int);
final spOpen =
    _lib.lookupFunction<_SpOpenC, _SpOpenDart>('sp_open');

typedef _SpCloseC = Int32 Function(Pointer<Void>);
typedef _SpCloseDart = int Function(Pointer<Void>);
final spClose =
    _lib.lookupFunction<_SpCloseC, _SpCloseDart>('sp_close');

typedef _SpFreePortC = Void Function(Pointer<Void>);
typedef _SpFreePortDart = void Function(Pointer<Void>);
final spFreePort =
    _lib.lookupFunction<_SpFreePortC, _SpFreePortDart>('sp_free_port');
...
final spSetFlowcontrol =
    _lib.lookupFunction<_SpSetFlowcontrolC, _SpSetFlowcontrolDart>('sp_set_flowcontrol');
...
final spGetFlowcontrol =
    _lib.lookupFunction<_SpGetFlowcontrolC, _SpGetFlowcontrolDart>('sp_get_flowcontrol');

// ---------- I/O ----------
typedef _SpBlockingReadC = Int32 Function(Pointer<Void>, Pointer<Void>, Int32, Uint32);
typedef _SpBlockingReadDart = int Function(Pointer<Void>, Pointer<Void>, int, int);
final spBlockingRead =
    _lib.lookupFunction<_SpBlockingReadC, _SpBlockingReadDart>('sp_blocking_read');

typedef _SpBlockingWriteC = Int32 Function(Pointer<Void>, Pointer<Void>, Int32, Uint32);
typedef _SpBlockingWriteDart = int Function(Pointer<Void>, Pointer<Void>, int, int);
final spBlockingWrite =
    _lib.lookupFunction<_SpBlockingWriteC, _SpBlockingWriteDart>('sp_blocking_write');
...
final spInputWaiting =
    _lib.lookupFunction<_SpInputWaitingC, _SpInputWaitingDart>('sp_input_waiting');
